...
## was using prevalence if per 1000 pop, but using % for now
...
viz_focus %>% arrange( desc( rent_own_ratio ) )  %>% head( 10 )

# this maybe ok list, but double check that they indeed got no funding!
...
NOTE: this may not be county with higher crhonic for all 58, just those that fit the 
rural high renter old age criteria
