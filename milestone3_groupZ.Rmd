...
removed decimal point from numeric cost column in funding data so it would look better
```{r}
funding_data_new<- funding_data$Numeric_Cost<-round(funding_data$Numeric_Cost,3)
```
