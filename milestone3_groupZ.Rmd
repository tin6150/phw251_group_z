...
There are many zeros in this table, they may not truly represent no cases, 
...
chronic_table = demographics_chronic_rural %>% 
  ...
  rename( Sum = `Sum of means chronic cases` ) %>%
  arrange( desc( `Sum` ) ) 

# Sum = "Sum of means chronic cases"
...
kable( chronic_table,
       ...
       caption = "Number of People Suffering from Each Chronic Illness Type by County", 
       )
