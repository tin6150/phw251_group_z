...
#tried adding column to show whether county wasrural or not, but couldn't figure it outrural_not_rural<-demographics_data %>% select(c(name, rural_class)) %>% rename(County=name)
...
kable( chronic_table,
       ...
       format.args=list(big.mark=','), caption = "Number of People Suffering from Each Chronic Illness Type by County", 
       )
#idk how to make font size bigger for caption
